...
def one_experiment(
    ...
    if data_path is None:
        data_path = import_path + "/dataset/esol/ESOL.csv"
    if fig_path is None:
        fig_path = (
            import_path
            + f"/results/ESOL/{encoding}_Results/confidence_mae_model_{encoding}_{target}.png"
        )
    if encoding_path is None:
        root_enc_path = import_path + "/dataset/esol"
