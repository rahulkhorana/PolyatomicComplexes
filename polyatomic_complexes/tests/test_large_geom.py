...
from polyatomic_complexes.tests.test_geom import (
...
from polyatomic_complexes.tests.test_geom_unique import (
...
#### LARGE UNIQUE ####
large_cases_pair = []
for smile1 in ALL_SMILES:
    for smile2 in ALL_SMILES:
        if smile1 != smile2:
            for mode in modes:
